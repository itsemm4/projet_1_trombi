const person = [
  ...
  },
  {
    ...
    stack: "Js",
    gender: "./assets/icons/male.png",
    description: "Je suis Shrek, un grand ogre vert avec des oreilles en forme de trompette. J’aime ma tranquillité dans mon marais, même si je me retrouve souvent à sauver la mise.",
    quote: "La c'est le moment où vous partez en hurlant.",
    levelHtml: 100,
    levelCss: 100,
    levelJs: 100,
    isPerfect: true,
